<template>
    ...
    <div class="work-card work-main-card flex-between">
      <div class="flex-center work-slogan-card">
        <div>
          <n-avatar
            round
            :size="isMobile ? 55 : 125"
            :src="infoPhoto"
          />
        </div>
        <div
          class="slogan-card flex-column"
          style="gap: 1rem"
        >
          ...
          <div class="work-slogan work-vise-slogan">
            一个开源的企业业务管理系统——全栈开发脚手架
          </div>
        </div>
      </div>
      <div
        v-if="!isMobile"
        style="position: relative; align-self: self-end"
      >
        <img
          style="
            position: absolute;
  ...
  <div
    class="flex work-main work-card work-middle-card"
    style="margin-top: 10px"
  >
    <div style="flex: 1" class="card-item">
      <techstackCard> </techstackCard>
    </div>
    <div class="card-item">
      <div class="card-item-title">版本号</div>
      <div style="font-size: 25px; text-align: end">
        1.0.0
      </div>
    </div>
    ...
    <div class="card-item">
      ...
      <div style="font-size: 25px; text-align: end">
        {{ dayjs().format('YYYY年-MM月-DD日') }}
      </div>
    </div>
    <div class="card-item" style="flex: 1">
      <div class="card-item-title">项目意义</div>
      <div
        style="
          font-size: 25px;
          text-align: end;
  ...
  <div
    class="flex-center work-main work-card work-bottom-card flex-1"
    style="margin-top: 10px"
  >
    <div
      style="font-size: 108px; color: white"
      class="flex-1 h-full"
    >
      <onlineMap></onlineMap>
    </div>
...
import onlineMap from './online-map/online-map.vue'
